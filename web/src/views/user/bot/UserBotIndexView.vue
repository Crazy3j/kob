                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="mb-3">
                      ...
                      <input v-model="botAdd.title" class="form-control" id="add-bot-title"
                    ...
                    <div class="modal-dialog modal-xl">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="mb-3">
                            <label for="add-bot-title" class="form-label">名称</label>
                            <input v-model="bot.title" class="form-control" id="add-bot-title"
                                   placeholder="请输入Bot名称">
                          </div>
                          <div class="mb-3">
                            <label for="add-bot-description" class="form-label">简介</label>
...
export default {
  ...
  setup() {
    ...
    const refresh_bots = () => {
      $.ajax({
        url: "https://app5293.acapp.acwing.com.cn/api/user/bot/getlist/",
        type: "get",
        headers: {
    ...
    const add_bot = () => {
      ...
      $.ajax({
        url: "https://app5293.acapp.acwing.com.cn/api/user/bot/add/",
        type: "post",
        data: {
          title: botAdd.title,
    ...
    const update_bot = (bot) => {
      botAdd.error_message = "";
      $.ajax({
        url: "https://app5293.acapp.acwing.com.cn/api/user/bot/update/",
        type: "post",
        data: {
          bot_id: bot.id,
          title: bot.title,
    ...
    const remove_bot = (bot) => {
      $.ajax({
        url: "https://app5293.acapp.acwing.com.cn/api/user/bot/remove/",
        type: "post",
        data: {
          bot_id: bot.id,
        },
